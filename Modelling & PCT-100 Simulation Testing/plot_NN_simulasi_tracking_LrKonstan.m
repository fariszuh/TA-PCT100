clear; clc; close all;
out1 = load('SP=dynamic_MOV=0.5_lrinit=0.001_alpha=0.mat');
...
out2 = load('SP=dynamic_MOV=0.5_lrinit=0.01_alpha=0.mat');
...
out3 = load('SP=dynamic_MOV=0.5_lrinit=0.1_alpha=0.mat');
...
out4 = load('SP=dynamic_MOV=0.5_lrinit=1_alpha=0.mat');
...
out5 = load('SP=dynamic_MOV=0.5_lrinit=2_alpha=0.mat');
...
out6 = load('SP=dynamic_MOV=0.5_lrinit=5_alpha=0.mat');
...
out7 = load('SP=dynamic_MOV=0.5_lrinit=10_alpha=0.mat');
...
figure;
hold on;
title("Plot Tracking Step Level, Variasi Learning Rate Konstan");
xlabel("t (detik)");
ylabel("Level (mm)");
plot(t_simulink1,mmlevel1,"DisplayName","Level saat lr=0.001");
plot(t_simulink2,mmlevel2,"DisplayName","Level saat lr=0.01");
plot(t_simulink3,mmlevel3,"DisplayName","Level saat lr=0.1");
plot(t_simulink4,mmlevel4,"DisplayName","Level saat lr=1");
plot(t_simulink5,mmlevel5,"DisplayName","Level saat lr=2");
plot(t_simulink6,mmlevel6,"DisplayName","Level saat lr=5");
plot(t_simulink7,mmlevel7,"DisplayName","Level saat lr=10");
...
figure;
hold on;
title("Plot u_{flow valve} Tracking Step Level, Variasi Learning Rate Konstan");
xlabel("t (detik)");
ylabel("Tegangan Flow Valve (volt)");
plot(t_valve1,u_valve1,"DisplayName","u_{flow valve} saat lr=0.001");
plot(t_valve2,u_valve2,"DisplayName","u_{flow valve} saat lr=0.01");
plot(t_valve3,u_valve3,"DisplayName","u_{flow valve} saat lr=0.1");
plot(t_valve4,u_valve4,"DisplayName","u_{flow valve} saat lr=1");
plot(t_valve5,u_valve5,"DisplayName","u_{flow valve} saat lr=2");
