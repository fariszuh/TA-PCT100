clear; clc; close all;
out1 = load('SP=100_MOV=dynamic_lrinit=1e-05_alpha=0.0001.mat');
...
out2 = load('SP=100_MOV=dynamic_lrinit=1e-05_alpha=0.001.mat');
...
out3 = load('SP=100_MOV=dynamic_lrinit=1e-05_alpha=0.01.mat');
...
out4 = load('SP=100_MOV=dynamic_lrinit=1e-05_alpha=0.1.mat');
...
out5 = load('SP=100_MOV=dynamic_lrinit=1e-05_alpha=1.mat');
...
% out6 = load('SP=100_MOV=dynamic_lrinit=1e-05_alpha=2.mat');
...
% lr6 = out6.lr_save;
% 
% out7 = load('SP=100_MOV=dynamic_lrinit=1e-05_alpha=5.mat');
...
figure;
hold on;
title("Plot Level Kondisi Berbeban, Variasi Alpha");
xlabel("t (detik)");
ylabel("Level (mm)");
...
figure;
hold on;
title("Plot Sinyal Kontrol Flow Valve Kondisi Berbeban, Variasi Alpha");
xlabel("t (detik)");
ylabel("Tegangan Flow Valve (volt)");
plot(t_valve5,u_valve5,'yellow',"DisplayName","u saat alpha=1");
plot(t_valve4,u_valve4,'cyan',"DisplayName","u saat alpha=0.1");
plot(t_valve3,u_valve3,'green',"DisplayName","u saat alpha=0.01");
plot(t_valve2,u_valve2,'blue',"DisplayName","u saat alpha=0.001");
plot(t_valve1,u_valve1,'red',"DisplayName","u saat alpha=0.0001");
...
figure;
hold on;
title("Plot Learning Rate Kondisi Berbeban, Variasi Alpha");
xlabel("t (detik)");
...
hold on;
title("Plot Square Error Kondisi Berbeban, Variasi Alpha");
xlabel("t (detik)");
...
% plot(t_simulink6,SE6,"DisplayName","SE alpha=0.0001");
% plot(t_simulink7,SE7,"DisplayName","SE alpha=0.0001");
% plot(t_simulink1,step_SPlevel1,"DisplayName","Set Point");
legend;
hold off;
